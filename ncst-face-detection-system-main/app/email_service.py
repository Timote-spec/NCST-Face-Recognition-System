...
def send_registration_verification_email(to_email: str, otp: str) -> None:
    subject = "NCST Face Recognition — Verify Your Email"
    body = f"""Hello,

Use this verification code to complete your NCST Face Recognition admin account registration:
